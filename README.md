...
Unlike conventional client-switchers, targeted hotkeys in **EVE-min** don't switch between characters. Instead, hotkeys switch between active clients based on an order of character names you provide. The idea is for hotkeys to remain tight regardless of character selection or count. For example, if you've got characters 1, 4, and 7 logged in, the hotkeys would stay as 1, 2, and 3. If you log out of 7 and into 9, the hotkeys are still 1, 2, and 3.
...
Without minimizing I use what feels like the whole GPU *(1 active client, 4 unfocused, 0 minimized)*:
...
With minimizing I use less than half of the GPU *(1 active client, 0 unfocused, 4 minimized)*:
